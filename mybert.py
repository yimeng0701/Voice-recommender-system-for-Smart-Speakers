...
Original file is located at
    https://colab.research.google.com/drive/1h1Bsn06KPVDOW9XD1hI1HAqNS0v3GRUJ
"""
...
if __name__ == "__main__":
  ...
  dir_name = os.path.join(path,'working')
  if not os.path.exists(dir_name):
      os.makedirs(dir_name)
  open(os.path.join(dir_name,train_file), 'w+').close()

      
  file_based_convert_examples_to_features(
            train_examples, MAX_SEQ_LENGTH, tokenizer, os.path.join(path,train_file))
  ...
  train_input_fn = file_based_input_fn_builder(
    input_file=os.path.join(path,train_file),
